...
function Library:CreateTab(tabName, tabIconId)
    ...
    function Tab:AddDropdown(title, items, isMulti, callback)
        ...
        optionsContainer.ZIndex = 40
        optionsContainer.Parent = self.MainFrame
        ...
        local function updateDropdownPosition()
            ...
            local left = mainPos.X + 4
            local right = mainPos.X + mainSize.X - popupSize.X - 4
            local top = mainPos.Y + 4
            local bottom = mainPos.Y + mainSize.Y - popupSize.Y - 4

            local x = buttonPos.X + buttonSize.X + 6
            local y = buttonPos.Y

            -- Jika sisi kanan penuh, popup pindah ke sisi kiri dropdown.
            if x > right then
            ...
            optionsContainer.Position = UDim2.new(0, x - mainPos.X, 0, y - mainPos.Y)
        end
