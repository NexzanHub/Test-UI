--[=[
================================================================================
              NEXZAN UI LIBRARY + KEY SYSTEM (RAYFIELD STYLE)
================================================================================
    Cara Penggunaan dari Luar Script (seperti Rayfield):

    local Library = loadstring(game:HttpGet("LINK_RAW"))()
    ...
    MainTab:CreateToggle("ESP", "", false, function(state) print(state) end)

    Key yang valid: "Nexzan Test"
================================================================================
]=]
...
local KeySystemConfig = {
    ...
    ValidKeys = {
        "NEXZAN2025",
        "PREMIUM-KEY-001",
        "Nexzan Test",           -- Key untuk testing dari luar
...
-- ========================== START SCRIPT (RAYFIELD STYLE) ==========================
-- Script ini akan return Library setelah Key berhasil diverifikasi
-- Cara pakai dari luar (seperti Rayfield):
--
-- local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/NexzanHub/Test-UI/refs/heads/main/Nexzan_Full_UI_With_KeySystem.lua"))()
-- 
-- local Window = Library:CreateWindow({ Title = "My Script", Size = UDim2.new(0, 550, 0, 380) })
-- local Tab = Window:CreateTab("Main")
-- Tab:CreateToggle("ESP", "Enable ESP", false, function(state) print(state) end)

local NexzanLibrary = nil

CreateKeySystem(function()
    NexzanLibrary = LoadNexzanLibrary()
    print("[Nexzan] Key berhasil! Library siap digunakan dari luar script.")
end)

-- Tunggu Key System selesai
repeat task.wait() until NexzanLibrary ~= nil

return NexzanLibrary